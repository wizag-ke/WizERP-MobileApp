...
const AddPurchaseOrderScreen = ({ route }: any) => {
    ...
    const handleSaveBtnClick = () => {
        setIsActiveBtn(true);
        navigation.navigate(screenName.PurchaseReturnDebitNotesDetails as never)
    };
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    <View style={{ paddingBottom: '30%' }}>
                        <SmallCard style={mv10}>
                            <H12redTwo600 style={[mh10]}>Purchase Order ID :  #PO-0009</H12redTwo600>
                        </SmallCard>
                        ...
                        <CustomTextInputField name={labels.purchasesOrderDate} control={control} placeholder={labels.selectDate} label={labels.purchasesOrderDate} showIcon={true} showCalendar={true} iconName='calendar' iconType='Feather' iconSize={16} />
                        ...
                        {/* <CustomNavigateBox name='Add Product' label={labels.products} onNavigate={() => navigation.navigate(screenName.ProductScreen as never)} color={colors.primary} /> */}
                        {
                            isAddedProductAvailable ? (
                                ...
                                <CustomNavigateBox name='Add Product' label={labels.products} onNavigate={() => navigation.navigate(screenName.ProductScreen, { fromScreen: labels.addPurchaseOrder } as never)} color={colors.primary} />
                            )
                        }
