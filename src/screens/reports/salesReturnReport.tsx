...
export type SalesReturnReportProps = {
    
    }


const SalesReturnReport = (props: SalesReturnReportProps) => {
    ...
    return (
        <View style={[flex1, { backgroundColor: colors.whiteTwo }]}>
            <View style={mh15}>
                <View style={mv15}>
                    <TopHeader headerText={labels.salesReturn} searchIcon={true} searchName={'Search' + labels.inventory} searchText={labels.salesReturn} />
                </View>
                <BottomWidth style={[mv5]} />
                <ScrollView>
                    <View style={{ paddingBottom: '50%' }}>
                        <H16BlackOne700>{labels.salesReturnbyLast30Days}</H16BlackOne700>
                        <ListSubHeader listName={labels.salesReturn} totalNumber={'21'} onFilterPress={openFilterModal} />
