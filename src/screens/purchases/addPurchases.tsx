...
import { H12Primary400, H12blackTwo600, H14Danger400, H14blackOne600, H14blackTwo400, H14blackTwo600, H18BlackOne700 } from '../../utils/styledComponents';
...
const AddPurchases = ({route}:any) => {
    ...
    const handleSaveBtnClick = () => {
        setIsActiveBtn(true);
        navigation.navigate(screenName.PurchasesDetails as never)
    };
        ...
        <View style={[flex1, mt10, mh10]}>
            <View style={mv15}>
                <TopHeader headerText={labels.addPurchase} />
                    ...
                    <CustomTextInputField name={labels.vendorName} control={control} placeholder={"Select " + labels.vendorName} label={labels.vendorName} showIcon={true} subHead='Add New' color={colors.primary} />
                    <CustomTextInputField name={labels.purchasesDate} control={control} placeholder={labels.selectDate} label={labels.purchasesDate} showIcon={true} showCalendar={true} iconName='calendar' iconType='Feather' iconSize={16} />
                    ...
                    <CustomTextInputField name={labels.supplierInvoiceSerialNumber} control={control} placeholder={labels.selectDate} label={labels.supplierInvoiceSerialNumber} showIcon={true} showCalendar={true} iconName='calendar' iconType='Feather' iconSize={16} />
                    {
                    isAddedProductAvailable ? (
                        ...
                        <CustomNavigateBox name='Add Product' label={labels.products} onNavigate={() => navigation.navigate(screenName.ProductScreen, {fromScreen : labels.purchases} as never)} color={colors.primary} />
                    )
                }
