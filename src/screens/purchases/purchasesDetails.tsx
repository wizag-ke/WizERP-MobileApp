...
export type purchasesDetailsProps = {
    
    }


const PurchasesDetails = (props: purchasesDetailsProps) => {
    return (
        <View style={[flex1, { backgroundColor: colors.white }]}>
        <ScrollView showsVerticalScrollIndicator={false}>
            <View style={[flex1, mt10, mh10, mb10]}>
                <TopHeader headerText={labels.purchaseDetails} searchIcon={false} />
                <View style={[flexRow, justifyBetween, alignItemCenter, mv10]}>
                    <View>
                        <H18BlackOne700>{labels.purchaseDetails}</H18BlackOne700>
                    </View>
