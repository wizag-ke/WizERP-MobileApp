...
export type salesReturnDetailsProps = {
    
    }


const SalesReturnDetails = (props: salesReturnDetailsProps) => {
    return (
        <View style={[flex1, { backgroundColor: colors.white }]}>
        <ScrollView showsVerticalScrollIndicator={false}>
            <View style={[flex1, mt10, mh10, mb10]}>
                <TopHeader headerText={labels.salesReturnDetails} searchIcon={false} />
                <View style={[flexRow, justifyBetween, alignItemCenter, mv10]}>
                    <View>
                        <H18BlackOne700>{labels.salesReturnDetails}</H18BlackOne700>
                    </View>
