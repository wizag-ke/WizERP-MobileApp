...
const AddPurchaseOrderScreen = ({ route }: any)=> {
    ...
    const handleSaveBtnClick = () => {
        setIsActiveBtn(true);
        navigation.navigate(screenName.PurchaseOrderDetails as never)
    };
                ...
                <View style={mv15}>
                    <TopHeader headerText={labels.addPurchaseOrder} />
                        ...
                        isAddedProductAvailable ? (
                            ...
                            <CustomNavigateBox name='Add Product' label={labels.products} onNavigate={() => navigation.navigate(screenName.ProductScreen, {fromScreen : labels.purchaseOrder} as never)} color={colors.primary} />
                        )
                    }
