            ...
            <View style={mv15}>
                <TopHeader headerText={labels.addpurchaseReturn} />
                    ...
                    <SmallCard style={mv10}>
                        <H12redTwo600 style={[mh10]}>Purchase Return ID :  #DEBIT-0012</H12redTwo600>
                    </SmallCard>
                    ...
                    isAddedProductAvailable ? (
                        ...
                        <CustomNavigateBox name='Add Product' label={labels.products} onNavigate={() => navigation.navigate(screenName.ProductScreen, {fromScreen : labels.purchaseReturn} as never)} color={colors.primary} />
                    )
                }
