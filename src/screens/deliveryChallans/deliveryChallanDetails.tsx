...
import { H18BlackOne700, H12white600, H14blackOne600, H14blackTwo400, H12BlackTwo500, SmallCard, H12redTwo600, H12blackTwo400, H12BlackOne600, H14blackTwo600 } from '../../utils/styledComponents';
import { colors } from '../../utils/theme/colors';
import { flex1, mt10, mh10, mb10, flexRow, justifyBetween, alignItemCenter, mv10, justifyCenter, ml5, ml15, ml10, alignItemStart, mt5, mr10, mt15, mv15, mh15, alignSelfCenter, justifyStart, mv5, justifyAround } from '../../utils/theme/commonStyles';

export type deliveryChallanDetailsProps = {

}


const DeliveryChallanDetailsScreen = (props: deliveryChallanDetailsProps) => {
    return (
        <View style={[flex1, { backgroundColor: colors.white }]}>
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={[flex1, mt10, mh10, mb10]}>
                    <TopHeader headerText={labels.deliveryChallanDetails} searchIcon={false} />
                    <View style={[flexRow, justifyBetween, alignItemCenter, mv10]}>
                        <View>
                            <H18BlackOne700>Delivery Challan</H18BlackOne700>
                        </View>
                    ...
                    <View style={[{ height: 180, width: '100%', backgroundColor: colors.white, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.50, shadowRadius: 3.84, elevation: 2, borderRadius: 8 }, justifyCenter]}>
                        <View style={[flexRow, justifyBetween, alignItemCenter,]}>
                            ...
                            <View style={[mr10]}>
                                <H14blackOne600>Challan ID</H14blackOne600>
                                <View style={[{ height: 40, width: 150, backgroundColor: colors.greyOne, borderRadius: 5 }, alignItemStart, justifyCenter, mt5]}>
                                    <H14blackTwo400 style={[ml10]}>DC - 000015</H14blackTwo400>
                                </View>
                            </View>
                        </View>
                        <View style={[flexRow, justifyBetween, alignItemCenter, mt15]}>
                            <View style={[ml10]}>
                                <H14blackOne600>Quotation To</H14blackOne600>
